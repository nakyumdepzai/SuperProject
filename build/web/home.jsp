<%-- 
    Document   : home
    Created on : Oct 12, 2023, 3:48:08 PM
...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#!">Expense Sharing</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="addExpense.jsp">Them chi tieu</a></li>
                        <li class="nav-item"><a class="nav-link" href="modifyExpense.jsp">Chinh sua chi tieu</a></li>
                        <li class="nav-item"><a class="nav-link" href="profile.jsp">Ho so</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="py-5 bg-image-full" style="background-image: url('https://source.unsplash.com/wfh8dDlNFOk/1600x900')">
            <div class="text-center my-5">
                <img class="img-fluid rounded-circle mb-4" src="img/logo.png" alt="..." />
